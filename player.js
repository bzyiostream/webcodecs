...
class Player {
    ...
    async init(videoElement) {
        ...
        this.vdecoder_.configure({ codec: 'vp09.00.10.08', width: 1920, height: 1080 ,bitrate: 4_000_000,framerate: 30});
        ...
        this.socket_ = new WebSocket("wss://default.zlmediakit.com:8000/sub");
