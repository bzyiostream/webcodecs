...
class Pusher {
    ...
    async init(videoElement) {
        ...
        this.socket_ = new WebSocket("wss://default.zlmediakit.com:8000/pub");
        ...
        this.vencoder_.configure({ codec: 'vp09.00.10.08', width: 1920, height: 1080 ,bitrate: 4_000_000,framerate: 30});
        ...
        const astream = await navigator.mediaDevices.getUserMedia({audio:{channelCount:2,sampleRate:48000}});

        let aprocessor = new MediaStreamTrackProcessor(astream.getAudioTracks()[0]);
